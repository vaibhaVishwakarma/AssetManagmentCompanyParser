...
datadir = '/Users/njp60/Documents/code/mutualfundbackend/funddata/data/Motilal Oswal Mutual Fund/'
output_file = 'motilaloswal_mutual_fund_portfolio.xlsx'
        ...
        if len(data.columns) >= 7 and return_df_if_has_isin(data) is not None:
            ...
            if header_row_idx is not None:
                ...
                if 'Coupon Rate (%)' in data.columns:
                    data['Yield'] = data['Coupon Rate (%)'].fillna(0)
