...
datadir = '/Users/njp60/Documents/code/mutualfundbackend/funddata/data/JM Financial Mutual Fund/'
output_file = 'jmfinancial_mutual_fund_portfolio.xlsx'
        ...
        if len(data.columns) >= 6 and return_df_if_has_isin(data) is not None:
            ...
            if header_row_idx is not None:
                ...
                if 'Coupon Rate' in data.columns:
                    data['Yield'] = pd.to_numeric(data['Coupon Rate'].str.replace('%', ''), errors='coerce').fillna(0)
