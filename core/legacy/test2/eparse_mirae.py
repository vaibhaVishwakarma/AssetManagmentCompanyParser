...
datadir='/Users/njp60/Documents/code/mutualfundbackend/funddata/data/Mirae Asset Mutual Fund/'
filename='NIMF_MONTHLY_PORTFOLIO_31-Jan-25.xls'
output_file = 'mirae_mutual_fund_porfolio.xlsx'
        ...
        if sheet_name not in sheets_to_avoid:
                ...
                if fund is not None and sheet_name:
                    ...
                    for x in df_clean.columns:
                        if "ESG" in x:
                            print("⚠️ Skipping {sheet_name} (ESG fund)")
