...
datadir = '/Users/njp60/Documents/code/mutualfundbackend/funddata/data/Bank of India Mutual Fund/'
output_file = 'bankofindia_mutual_fund_portfolio.xlsx'
        ...
        if len(data.columns) >= 6 and return_df_if_has_isin(data) is not None:
            ...
            if header_row_idx is not None:
                ...
                if 'Coupon Rate' in data.columns or 'Rate (%)' in data.columns:
                    ...
                    if 'Asset Class' in data.columns:
                        data['Type'] = data['Asset Class'].apply(
