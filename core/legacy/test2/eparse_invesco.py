...
datadir = '/Users/njp60/Documents/code/mutualfundbackend/funddata/data/Invesco Mutual Fund/'
output_file = 'invesco_mutual_fund_portfolio.xlsx'
    ...
    for i, df in enumerate(df_generator):
        ...
        if len(data.columns) >= 6 and return_df_if_has_isin(data) is not None:
            ...
            if header_row_idx is not None:
                ...
                if 'Coupon Rate (%)' in data.columns:
                    data['Yield'] = pd.to_numeric(data['Coupon Rate (%)'], errors='coerce').fillna(0)
