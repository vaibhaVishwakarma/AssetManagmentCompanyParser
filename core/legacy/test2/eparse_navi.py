...
datadir = '/Users/njp60/Documents/code/mutualfundbackend/funddata/data/Navi Mutual Fund/'
output_file = 'navi_mutual_fund_portfolio.xlsx'
    ...
    for i, df in enumerate(df_generator):
        ...
        if len(data.columns) >= 7 and return_df_if_has_isin(data) is not None:
            ...
            if header_row_idx is not None:
                ...
                # Add Yield and Type columns based on instrument type
                if 'Coupon' in data.columns:
                    data['Yield'] = data['Coupon'].fillna(0)
