...
datadir = '/Users/njp60/Documents/code/mutualfundbackend/funddata/data/DSP Mutual Fund/'
output_file = 'dsp_mutual_fund_portfolio.xlsx'
        ...
        if len(data.columns) >= 6 and return_df_if_has_isin(data) is not None:
            ...
            if header_row_idx is not None:
                ...
                if 'Coupon' in data.columns or 'Rate (%)' in data.columns:
                    ...
                    if 'Asset Type' in data.columns:
                        data['Type'] = data['Asset Type'].apply(
